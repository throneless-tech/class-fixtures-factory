...
var reflect = require('tinspector');
var reflect__default = _interopDefault(reflect);
var tslib = require('tslib');
var classValidator = require('class-validator');
var faker = _interopDefault(require('faker'));
var chalk = _interopDefault(require('chalk'));
var treeify = _interopDefault(require('treeify'));
...
function Fixture(options) {
    return reflect.decorateProperty({
        type: 'Fixture',
        value: options,
    });
}
...
var ClassValidatorAdapter = /** @class */ (function () {
    ...
    ClassValidatorAdapter.prototype.extractMedatada = function (classType) {
        var metadata = classValidator.getFromContainer(classValidator.MetadataStorage).getTargetValidationMetadatas(classType, '');
    ...
    ClassValidatorAdapter.prototype.makePropertyMetadata = function (cvMeta, existingProp) {
        var prop = tslib.__assign({ name: cvMeta.propertyName }, (existingProp || {}));
        var data = {
            type: null,
            max: null,
            min: null,
        ...
        switch (cvMeta.type) {
            case 'isBoolean': {
                return tslib.__assign(tslib.__assign({}, prop), { type: prop.type || 'boolean', input: function () { return faker.random.boolean(); } });
            }
            case 'isDate': {
                data.type = 'date';
                break;
            ...
            case 'isIn': {
                ...
                return tslib.__assign(tslib.__assign({}, prop), { type: prop.type || 'any', input: function () { return faker.random.arrayElement(items_1); } });
            }
            case 'equals':
                return tslib.__assign(tslib.__assign({}, prop), { type: prop.type || 'any', input: function () { return cvMeta.constraints[0]; } });
            case 'isEmpty':
                return tslib.__assign(tslib.__assign({}, prop), { type: prop.type || 'any', input: function () { return null; } });
            case 'isPositive':
                data.type = 'number';
                data.min = 1;
                break;
            ...
            case 'contains': {
                ...
                return tslib.__assign(tslib.__assign({}, prop), { type: prop.type || 'any', input: function () { return "" + faker.random.word() + value_1 + faker.random.word(); } });
            }
            case 'isAlpha':
                data.type = 'alpha';
                break;
            ...
            case 'isDecimal':
                ...
                break;
            case 'isEmail':
                return tslib.__assign(tslib.__assign({}, prop), { type: 'string', input: function () { return faker.internet.email(); } });
            case 'isFqdn':
                return tslib.__assign(tslib.__assign({}, prop), { type: 'string', input: function () { return faker.internet.domainName(); } });
            case 'isHexColor':
                return tslib.__assign(tslib.__assign({}, prop), { type: 'string', input: function () { return faker.internet.color(); } });
            case 'isLowercase':
                data.type = 'alpha';
                data["case"] = 'lower';
                break;
            case 'isUppercase':
                ...
                break;
            case 'length': {
                var _a = tslib.__read(cvMeta.constraints, 2), min = _a[0], max = _a[1];
                data.min = min;
                data.max = max || 6;
                data.type = 'alpha';
                break;
            ...
            case 'arrayContains': {
                ...
                return tslib.__assign(tslib.__assign({}, prop), { type: 'string', input: function () { return value_2; } });
            }
            case 'arrayMinSize': {
                var value = cvMeta.constraints[0];
                data.type = 'array';
        ...
        switch (data.type) {
            case 'number': {
                ...
                return tslib.__assign(tslib.__assign({}, prop), { type: 'number', input: function () { return value_3; } });
            }
            case 'decimal': {
                var min = data.min;
                var max = data.max;
                ...
                return tslib.__assign(tslib.__assign({}, prop), { type: 'number', input: function () { return value_4; } });
            }
            case 'date': {
                var min = data.min;
                var max = data.max;
                ...
                return tslib.__assign(tslib.__assign({}, prop), { type: 'Date', input: function () { return value_5; } });
            }
            case 'alpha': {
                var min = data.min;
                var max = data.max;
                ...
                return tslib.__assign(tslib.__assign({}, prop), { type: 'string', input: function () { return value_6; } });
            }
            case 'alphanumeric': {
                var min = data.min;
                var max = data.max;
                var ln_1 = faker.random.number({ min: min || 5, max: max || 10 });
                return tslib.__assign(tslib.__assign({}, prop), { type: 'string', input: function () {
                        return faker.random
            ...
            case 'array': {
                ...
                return tslib.__assign(tslib.__assign({}, prop), { max: data.max || prop.max, min: data.min || prop.min });
            }
        }
        if (!prop.type) {
...
var DefaultMetadataStore = /** @class */ (function (_super) {
    tslib.__extends(DefaultMetadataStore, _super);
    ...
    DefaultMetadataStore.prototype.make = function (classType) {
        ...
        var this_1 = this;
        try {
            for (var cvMetadata_1 = tslib.__values(cvMetadata), cvMetadata_1_1 = cvMetadata_1.next(); !cvMetadata_1_1.done; cvMetadata_1_1 = cvMetadata_1.next()) {
...
var FixtureFactory = /** @class */ (function () {
    ...
    function FixtureFactory(options) {
        ...
        this.options = tslib.__assign(tslib.__assign({}, this.DEFAULT_OPTIONS), (options || {}));
    }
    ...
    FixtureFactory.prototype.register = function (classTypes) {
        var e_1, _a;
        try {
            for (var classTypes_1 = tslib.__values(classTypes), classTypes_1_1 = classTypes_1.next(); !classTypes_1_1.done; classTypes_1_1 = classTypes_1.next()) {
        ...
        var result = {
            one: function () {
                ...
                try {
                    ...
                    try {
                        for (var _b = tslib.__values(Object.entries(userInput)), _c = _b.next(); !_c.done; _c = _b.next()) {
            ...
            many: function (x) {
                return tslib.__spread(Array(x).keys()).map(function () { return result.one(); });
            },
            "with": function (input) {
                var e_3, _a;
                userInput = input;
                try {
                    for (var _b = tslib.__values(Object.keys(input)), _c = _b.next(); !_c.done; _c = _b.next()) {
                        var key = _c.value;
    ...
    FixtureFactory.prototype.makeArrayProp = function (prop, meta, depth) {
        ...
        return tslib.__spread(Array(amount).keys()).map(function () {
            return _this.makeProperty(tslib.__assign(tslib.__assign({}, prop), { array: false }), meta, depth);
        });
    };
    ...
    FixtureFactory.prototype.findRefSideProps = function (meta, prop) {
        ...
        var refClassMeta = this.store.get(prop.type);
        try {
            for (var _b = tslib.__values(refClassMeta.properties), _c = _b.next(); !_c.done; _c = _b.next()) {
...
exports.BaseMetadataStore = BaseMetadataStore;
exports.DefaultMetadataStore = DefaultMetadataStore;
exports.FactoryLogger = FactoryLogger;
exports.Fixture = Fixture;
exports.FixtureFactory = FixtureFactory;
exports.getEnumValues = getEnumValues;
//# sourceMappingURL=class-fixtures-factory.cjs.development.js.map
